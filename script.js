...
function generateGame(){
	...
	function display(){
	 name1 = prompt("Enter the name for X");
	 name2 = prompt("Enter the name for O");
	 document.getElementById("score1").innerHTML=name1+" score:";
	 document.getElementById("score2").innerHTML=name2+" score:";
...
function markCheck(obj){
	...
	if (robot===true){
	 autoTurn();
	 document.getElementById("score1").innerHTML=" user:";
	 document.getElementById("score2").innerHTML=" computer:";
	} 
}
